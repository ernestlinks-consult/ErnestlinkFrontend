...
function AdminDashboard() {
  return (
    <Box sx={{ p: 4, bgcolor: "#F8FAFC", minHeight: "100vh" }}>
      {/* <Typography
        variant="h4"
        sx={{ fontWeight: 700, color: "#0505AA", mb: 4 }}>
        Admin Dashboard
      </Typography> */}
        ...
        <Grid item xs={12} md={6}>
          <Paper
            ...
            <Box
              ...
              <Typography
                variant="subtitle1"
                sx={{ fontWeight: 600, color: "#0505AA", fontSize: "28px" }}>
                Total Registrations
              </Typography>
              <InsertDriveFileOutlinedIcon sx={{ color: "#0505AA" }} />
            </Box>
            <Typography
              variant="h4"
              sx={{ fontWeight: 800, color: "#0505AA", fontSize: "44px" }}>
              1,658
            </Typography>
            <Typography
              variant="body2"
              sx={{ fontWeight: 400, color: "#0505AA", fontSize: "14px" }}>
        ...
        <Grid item xs={12} md={6}>
          <Paper
            ...
            <Box
              ...
              <GroupsOutlinedIcon sx={{ color: "#0505AA" }} />
            </Box>
            <Typography
              variant="h4"
              sx={{ fontWeight: 800, color: "#0505AA", fontSize: "44px" }}>
